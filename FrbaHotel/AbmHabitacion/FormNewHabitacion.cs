...
namespace FrbaHotel.AbmHabitacion
{
    public partial class FormNewHabitacion : Form
    {
        ...
        private void fillByToolStripButton_Click(object sender, EventArgs e)
        {
            try
            {
                this.tIPOS_HABITACIONTableAdapter.FillBy(this.gD1C2018DataSet.TIPOS_HABITACION);
            }
            catch (System.Exception ex)
            {
                System.Windows.Forms.MessageBox.Show(ex.Message);
        ...
        private void fillByTipoHabitacion1ToolStripButton_Click(object sender, EventArgs e)
        {
            try
            {
                this.tIPOS_HABITACIONTableAdapter.FillByTipoHabitacion1(this.gD1C2018DataSet.TIPOS_HABITACION);
            }
            catch (System.Exception ex)
            {
                System.Windows.Forms.MessageBox.Show(ex.Message);
        ...
        private void fillBy1ToolStripButton_Click(object sender, EventArgs e)
        {
            try
            {
                this.tIPOS_HABITACIONTableAdapter.FillBy1(this.gD1C2018DataSet.TIPOS_HABITACION);
            }
            catch (System.Exception ex)
            {
                System.Windows.Forms.MessageBox.Show(ex.Message);
