...
DROP FUNCTION LOS_MAGIOS.DAR_DISPONIBILIDAD;
GO
...
CREATE FUNCTION LOS_MAGIOS.DAR_DISPONIBILIDAD(@FECHA_DESDE DATE, @FECHA_HASTA DATE)
RETURNS TABLE
AS 
	RETURN SELECT DISTINCT HT.NOMBRE, H.NUMERO_HABITACION, H.PISO, H.UBICACION
	FROM LOS_MAGIOS.HABITACIONES H, LOS_MAGIOS.HABITACIONES_POR_RESERVA HR, LOS_MAGIOS.RESERVAS R, LOS_MAGIOS.HOTELES HT, LOS_MAGIOS.ESTADOS_RESERVA ER
	WHERE H.ID_HOTEL = HR.ID_HOTEL AND H.NUMERO_HABITACION = HR.NUMERO_HABITACION AND R.CODIGO_RESERVA = HR.CODIGO_RESERVA AND HT.ID_HOTEL = H.ID_HOTEL
