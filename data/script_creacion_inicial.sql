...
RETURNS TABLE
AS 
	RETURN SELECT DISTINCT HT.NOMBRE, H.NUMERO_HABITACION, H.PISO, H.UBICACION, LOS_MAGIOS.PRECIO_HABITACION(RG.PRECIO_DOLARES, @CANTIDAD_PERSONAS, HT.ESTRELLAS) AS PRECIO_HABITACION
	FROM LOS_MAGIOS.HABITACIONES H, LOS_MAGIOS.HABITACIONES_POR_RESERVA HR, LOS_MAGIOS.RESERVAS R, LOS_MAGIOS.HOTELES HT, LOS_MAGIOS.ESTADOS_RESERVA ER, LOS_MAGIOS.REGIMENES_POR_HOTEL RH, LOS_MAGIOS.REGIMENES RG, LOS_MAGIOS.TIPOS_HABITACION TH 
	WHERE H.ID_HOTEL = HR.ID_HOTEL AND H.NUMERO_HABITACION = HR.NUMERO_HABITACION AND R.CODIGO_RESERVA = HR.CODIGO_RESERVA AND HT.ID_HOTEL = H.ID_HOTEL AND HT.ID_HOTEL = RH.ID_HOTEL
		AND R.ID_ESTADO_RESERVA = ER.ID_ESTADO_RESERVA AND ER.DESCRIPCION_ESTADO_RESERVA NOT IN ('CANCELADA-NO-SHOW','CANCELADA-CLIENTE', 'CANCELADA-RECEPCION')
		AND (R.FECHA_DESDE > @FECHA_HASTA OR R.FECHA_HASTA <  @FECHA_DESDE)
...
RETURNS TABLE
AS 
	RETURN SELECT DISTINCT HT.NOMBRE, H.NUMERO_HABITACION, H.PISO, H.UBICACION, RG.DESCRIPCION as REGIMEN, LOS_MAGIOS.PRECIO_HABITACION(RG.PRECIO_DOLARES, @CANTIDAD_PERSONAS, HT.ESTRELLAS) AS PRECIO_HABITACION
	FROM LOS_MAGIOS.HABITACIONES H, LOS_MAGIOS.HABITACIONES_POR_RESERVA HR, LOS_MAGIOS.RESERVAS R, LOS_MAGIOS.HOTELES HT, LOS_MAGIOS.ESTADOS_RESERVA ER, LOS_MAGIOS.REGIMENES_POR_HOTEL RH, LOS_MAGIOS.REGIMENES RG, LOS_MAGIOS.TIPOS_HABITACION TH
	WHERE H.ID_HOTEL = HR.ID_HOTEL AND H.NUMERO_HABITACION = HR.NUMERO_HABITACION AND R.CODIGO_RESERVA = HR.CODIGO_RESERVA AND HT.ID_HOTEL = H.ID_HOTEL AND HT.ID_HOTEL = RH.ID_HOTEL
		AND R.ID_ESTADO_RESERVA = ER.ID_ESTADO_RESERVA AND ER.DESCRIPCION_ESTADO_RESERVA NOT IN ('CANCELADA-NO-SHOW','CANCELADA-CLIENTE', 'CANCELADA-RECEPCION')
		AND (R.FECHA_DESDE > @FECHA_HASTA OR R.FECHA_HASTA <  @FECHA_DESDE)
